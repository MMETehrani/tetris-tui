...
می‌تونی نسخه اجرایی (`.exe`) بازی رو مستقیماً از بخش **Releases** گیت‌هاب دانلود کنی و بدون نیاز به نصب پایتون، اجراش کنی.

**[لینک دانلود آخرین نسخه](https://github.com/MMETehrani/tetris-tui/releases/download/v1.0.0/tetris.exe)**
...
```
بعدش با دستور `cd tetris-tui` وارد پوشه پروژه شو.
